...
const mapDispatchToProps = (dispatch) => ({
  removeItem: (itemType, id) => dispatch(removeItemAction(itemType, id)) // dispatch wysyła akcje do reducera
});

export default connect(null, mapDispatchToProps)(withContext(Card)); //connect łączy komponent ze storem
